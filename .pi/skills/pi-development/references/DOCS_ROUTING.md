...
| Skills and Loadout behavior | `packages/hepi-skills/`, `packages/hepi-basics/src/loadout/`, `packages/hepi-basics/src/dollar-skill/` |
| TUI replay | `packages/hepi-debug/TUI_REPLAY.md` |
