...
const toggleFooter = "↕ navigate · ↔ switch · ␣ toggle · ⎋ close";
const editNavigationFooter = "↕ navigate · ↔ switch · ␣ edit · ⎋ close";
...
describe("settings component", () => {
	test("matches footer through toggle, edit, cancel, confirm, and close", async () => {
		...
		expect(state.host.renderRequests).toBeGreaterThan(8);
