...
import { getMemoryVerifications } from "../features/memory/storage-memory-verifications";
import type { getOrCreateSessionMeta } from "../features/storage";
import {
...
export interface RustModeModuleClient extends ModuleStateSyncClient {
    ...
    mirrorPull?(args: {
        ...
        live_only?: boolean;
        projectRoot?: string;
    }): Promise<{ page: import("../../features/context-authority").ChangefeedPage }>;
