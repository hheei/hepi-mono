...
} from "../features/context-authority";
import {
    resolveProjectIdentity,
    resolveProjectIdentityForSession,
    takeDubiousOwnershipProjectIdentityWarning,
} from "../features/memory/project-identity";
import { scheduleReconciliation } from "../features/message-index-async";
import { type Scheduler, parseCacheTtl } from "../features/scheduler";

import { recordSessionProjectIdentity } from "../features/session-project-storage";
import {
...
import { bumpProjectMemoryEpoch } from "../features/storage-project-state";
import type { Tagger } from "../features/tagger";
import type { ContextUsage } from "../features/types";
...
export function createTransform(deps: TransformDeps) {
    ...
    const transform = async (
        ...
        let sessionMeta: import("../../features/types").SessionMeta | undefined;
        try {
