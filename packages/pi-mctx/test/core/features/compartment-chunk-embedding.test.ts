...
import { embedAndStoreCompartmentChunks } from "../../../src/core/features/compartment-embedding";
...
import { clearSession } from "../../../src/core/features/storage-meta-session";
        ...
        try {
            ...
            const fromMemory = canonicalizeInMemoryChunkTextForEmbedding(
                [
                    ...
                    "[3-4] A: Embed raw compartment chunks. / TC: read(packages/plugin/src/features/search.ts)",
                ].join("\n"),
                1,
                4,
            );
