...
const {
    ...
    insertMemory,
} = await import("../../../../src/core/features/memory/storage-memory");
const { embedPromotedFacts, promoteSessionFactsDurable } = await import("../../../../src/core/features/memory/promotion");
