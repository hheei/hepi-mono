...
* User prefers terse communication.
    ...
    describe("runMemoryMigration — fallback escalation", () => {
        it("escalates to a configured fallback model when the primary returns empty output", async () => {
            ...
            const { resolveProjectIdentity } = await import("../../../../../src/core/features/magic-context/memory/project-identity");
            ...
            const { runMemoryMigration } = await import("../../../../../src/core/features/magic-context/memory/memory-migration");
