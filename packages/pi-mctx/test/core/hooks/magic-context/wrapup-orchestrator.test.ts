...
} from "../../../../src/core/features/magic-context/compartment-lease";
import {
    appendCompartments,
    getCompartments,
...
import { executeContextRecompWithResult, registerActiveCompartmentRun } from "../../../../src/core/hooks/magic-context/compartment-runner";
import { createLiveSessionState, type LiveSessionState } from "../../../../src/core/hooks/magic-context/live-session-state";
import { setRawMessageProvider } from "../../../../src/core/hooks/magic-context/read-session-chunk";
import { type ManagedWrapupContext, runManagedWrapup } from "../../../../src/core/hooks/magic-context/wrapup-orchestrator";
