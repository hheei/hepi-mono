...
import {
    ...
    isSessionReconciled,
} from "../../../../src/core/features/magic-context/message-index-async";
...
import { recordToolDefinition } from "../../../../src/core/features/magic-context/tool-definition-tokens";
...
describe("createTransform", () => {
    ...
    it("Unit B: subagent (ctx_reduce on) gets a Channel 1 baseline snapshot", async () => {
        ...
        const channel1StateBySession = new Map<
            string,
            import("../../../../src/core/hooks/magic-context/ctx-reduce-nudge").Channel1State
        >();
        const transform = createTransform({
            tagger: createTagger(),
            scheduler,
