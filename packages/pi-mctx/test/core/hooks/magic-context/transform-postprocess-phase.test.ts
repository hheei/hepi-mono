...
} from "../../../../src/core/features/magic-context/storage-meta-persisted";
import { createTagger } from "../../../../src/core/features/magic-context/tagger";
import { Database } from "../../../../src/core/shared/sqlite";
import { MARKER_SUMMARY_TEXT } from "../../../../src/core/hooks/magic-context/compaction-marker-manager";
import { registerActiveCompartmentRun } from "../../../../src/core/hooks/magic-context/compartment-runner";
import { clearToolPermissionDenied } from "../../../../src/core/hooks/magic-context/ctx-reduce-availability";
import { estimateMessageTokens } from "../../../../src/core/hooks/magic-context/final-wire-token-estimate";
import { injectM0M1, type M0HardSignals } from "../../../../src/core/hooks/magic-context/inject-compartments";
import {
    type MessageLike,
    type TagTarget,
    type ThinkingLikePart,
    tagMessages,
} from "../../../../src/core/hooks/magic-context/tag-messages";
import { buildSyntheticTodoPart, computeSyntheticCallId, isSyntheticTodoPart } from "../../../../src/core/hooks/magic-context/todo-view";
import {
    createToolDropTarget,
    extractToolCallObservation,
    type ToolCallIndex,
    ToolMutationBatch,
} from "../../../../src/core/hooks/magic-context/tool-drop-target";
import { applyFlushedStatuses } from "../../../../src/core/hooks/magic-context/transform-operations";
import {
...
} from "../../../../src/core/hooks/magic-context/transform-postprocess-phase";
