...
import { maybeDeliverChannel2 } from "../../../../src/core/hooks/magic-context/channel2-delivery";
...
describe("maybeDeliverChannel2", () => {
    ...
    it("preserves a sibling's delivered claim when token confirmation is no longer ours", async () => {
        ...
        const { maybeDeliverChannel2: deliver } = await import("../../../../src/core/hooks/magic-context/channel2-delivery");
