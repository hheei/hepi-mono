...
import {
    ...
    isSessionReconciled,
} from "../../../src/core/features/message-index-async";
import type { Scheduler } from "../../../src/core/features/scheduler";
import {
    clearPendingOps,
    closeDatabase,
...
import { recordToolDefinition } from "../../../src/core/features/tool-definition-tokens";
import type { ContextUsage } from "../../../src/core/features/types";
...
import { createTransform } from "../../../src/core/hooks/transform";
...
describe("createTransform", () => {
    ...
    it("Unit B: subagent (ctx_reduce on) gets a Channel 1 baseline snapshot", async () => {
        ...
        const channel1StateBySession = new Map<
            string,
            import("../../../../src/core/hooks/ctx-reduce-nudge").Channel1State
        >();
        const transform = createTransform({
            tagger: createTagger(),
            scheduler,
