...
const recompSrc = readFileSync(join(import.meta.dirname, "../../../src/core/hooks/compartment-runner-recomp.ts"), "utf8");
const historianSrc = readFileSync(join(import.meta.dirname, "../../../src/core/hooks/compartment-runner-historian.ts"), "utf8");
