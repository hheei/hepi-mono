...
import { appendCompartments } from "../../../src/core/features/compartment-storage";
import {
...
import { MARKER_SUMMARY_TEXT } from "../../../src/core/hooks/compaction-marker-manager";
import { registerActiveCompartmentRun } from "../../../src/core/hooks/compartment-runner";
import { clearToolPermissionDenied } from "../../../src/core/hooks/ctx-reduce-availability";
import { estimateMessageTokens } from "../../../src/core/hooks/final-wire-token-estimate";
import { injectM0M1, type M0HardSignals } from "../../../src/core/hooks/inject-compartments";
import {
    type MessageLike,
    type TagTarget,
    type ThinkingLikePart,
    tagMessages,
} from "../../../src/core/hooks/tag-messages";
import { buildSyntheticTodoPart, computeSyntheticCallId, isSyntheticTodoPart } from "../../../src/core/hooks/todo-view";
import {
    createToolDropTarget,
    extractToolCallObservation,
    type ToolCallIndex,
    ToolMutationBatch,
} from "../../../src/core/hooks/tool-drop-target";
import { applyFlushedStatuses } from "../../../src/core/hooks/transform-operations";
import {
...
} from "../../../src/core/hooks/transform-postprocess-phase";
