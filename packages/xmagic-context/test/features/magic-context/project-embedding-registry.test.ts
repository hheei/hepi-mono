...
import type { EmbeddingConfig } from "../../../src/config/schema/magic-context";
import {
    chunkCanonicalText,
...
import type { GitCommit } from "../../../src/features/magic-context/git-commits/git-log-reader";
import {
    countEmbeddedCommits,
    saveCommitEmbedding,
} from "../../../src/features/magic-context/git-commits/storage-git-commit-embeddings";
import { upsertCommits } from "../../../src/features/magic-context/git-commits/storage-git-commits";
import { acquireGitSweepLease, releaseGitSweepLease } from "../../../src/features/magic-context/git-commits/sweep-coordinator";
import type { EmbeddingProvider, EmbeddingPurpose } from "../../../src/features/magic-context/memory/embedding-provider";
import { insertMemory } from "../../../src/features/magic-context/memory/storage-memory";
import {
    getStoredModelId,
    loadAllEmbeddings,
    saveEmbedding,
} from "../../../src/features/magic-context/memory/storage-memory-embeddings";
import {
...
} from "../../../src/features/magic-context/project-embedding-registry";
...
import { beginSynapseBatchLedger } from "../../../src/features/magic-context/storage-embedding-measurements";
