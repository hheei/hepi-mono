...
import { CATEGORY_DEFAULT_TTL } from "../../../../src/features/magic-context/memory/constants";
...
import * as realEmbedding from "../../../../src/features/magic-context/memory/embedding";
...
const {
    ...
    insertMemory,
} = await import("../../../../src/features/magic-context/memory/storage-memory");
const { embedPromotedFacts, promoteSessionFactsDurable } = await import("../../../../src/features/magic-context/memory/promotion");
