...
import { COMPARTMENT_AGENT_SYSTEM_PROMPT } from "../../src/hooks/magic-context/compartment-prompt";
import { withContentLanguageDirective } from "../../src/agents/language-directive";
