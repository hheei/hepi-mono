...
import { MARKER_SUMMARY_TEXT } from "../../../src/hooks/magic-context/compaction-marker-manager";
import { registerActiveCompartmentRun } from "../../../src/hooks/magic-context/compartment-runner";
import { clearToolPermissionDenied } from "../../../src/hooks/magic-context/ctx-reduce-availability";
import { estimateMessageTokens } from "../../../src/hooks/magic-context/final-wire-token-estimate";
import { injectM0M1, type M0HardSignals } from "../../../src/hooks/magic-context/inject-compartments";
import {
    type MessageLike,
    type TagTarget,
    type ThinkingLikePart,
    tagMessages,
} from "../../../src/hooks/magic-context/tag-messages";
import { buildSyntheticTodoPart, computeSyntheticCallId, isSyntheticTodoPart } from "../../../src/hooks/magic-context/todo-view";
import {
...
} from "../../../src/hooks/magic-context/transform-postprocess-phase";
