...
import { buildHiddenAgentRegistrations } from "../../../src/agents/hidden-agent-registrations";
import { CLASSIFY_SYSTEM_PROMPT } from "../../../src/features/magic-context/dreamer/classify-prompt";
import { MAP_MEMORIES_SYSTEM_PROMPT } from "../../../src/features/magic-context/dreamer/map-memories-prompt";
import {
...
} from "../../../src/features/magic-context/dreamer/task-prompts";
import { VERIFY_SYSTEM_PROMPT } from "../../../src/features/magic-context/dreamer/verify-prompt";
import { MIGRATION_SYSTEM_PROMPT } from "../../../src/features/magic-context/memory/memory-migration";
import { SIDEKICK_SYSTEM_PROMPT } from "../../../src/features/magic-context/sidekick/agent";
import { SMART_NOTE_COMPILER_SYSTEM_PROMPT } from "../../../src/features/magic-context/smart-notes/compiler-prompt";
import {
    closeDatabase,
...
} from "../../../src/hooks/magic-context/compartment-prompt";
import {
    clearCtxReduceAvailability,
    resolveCtxReduceAvailabilityFromMessages,
} from "../../../src/hooks/magic-context/ctx-reduce-availability";
import { createSystemPromptHashHandler, isMagicContextInternalAgent } from "../../../src/hooks/magic-context/system-prompt-hash";
