...
import { reserveProtectedTailDrainTokens } from "../../../src/features/magic-context/storage-meta-persisted";
import { getPrimerCandidatesForProject } from "../../../src/features/magic-context/storage-primers";
import { getUserMemoryCandidates } from "../../../src/features/magic-context/user-memory/storage-user-memory";
import type { PluginContext } from "../../../src/plugin/types";
import { Database } from "../../../src/shared/sqlite";
import { closeQuietly } from "../../../src/shared/sqlite-helpers";
import { runCompartmentAgent } from "../../../src/hooks/magic-context/compartment-runner";
import {
    type ProtectedTailBoundarySnapshot,
    resolveWrapupProtectedTailBoundary,
} from "../../../src/hooks/magic-context/protected-tail-boundary";
import { readSessionChunk, setRawMessageProvider } from "../../../src/hooks/magic-context/read-session-chunk";
