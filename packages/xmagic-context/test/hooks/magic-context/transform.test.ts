...
import {
    ...
    isSessionReconciled,
} from "../../../src/features/magic-context/message-index-async";
...
import { recordToolDefinition } from "../../../src/features/magic-context/tool-definition-tokens";
import type { ContextUsage } from "../../../src/features/magic-context/types";
import type { PluginContext } from "../../../src/plugin/types";
import { clearModelsDevCache, refreshModelLimitsFromApi } from "../../../src/shared/models-dev-cache";
...
describe("createTransform", () => {
    ...
    it("Unit B: subagent (ctx_reduce on) gets a Channel 1 baseline snapshot", async () => {
        ...
        const channel1StateBySession = new Map<
            string,
            import("../../../src/hooks/magic-context/ctx-reduce-nudge").Channel1State
        >();
        const transform = createTransform({
            tagger: createTagger(),
            scheduler,
