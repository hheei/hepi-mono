...
import { setProjectState } from "../../../src/features/magic-context/storage-project-state";
import {
    insertTag,
    updateTagDropMode,
    updateTagStatus,
} from "../../../src/features/magic-context/storage-tags";
import { insertUserMemory } from "../../../src/features/magic-context/user-memory/storage-user-memory";
...
import {
    ...
    syncModuleState,
} from "../../../src/hooks/magic-context/module-state-sync";
import {
    MODULE_PAGE_MAX_BYTES,
    moduleWireBodyBytes,
    resolveOrdinalsForModule,
} from "../../../src/hooks/magic-context/module-wire";
