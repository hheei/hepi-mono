...
export const GITHUB_URL = "https://github.com/IgorWarzocha/howaboua-pi-stuff/tree/main/packages/pi-codex-conversion-lite";
...
export function openExternalUrl(url: string): void {
	...
	child.on("error", (error) => {
		console.warn(`[pi-codex-conversion-lite] Failed to open ${url}: ${error.message}`);
	});
	child.unref();
}
