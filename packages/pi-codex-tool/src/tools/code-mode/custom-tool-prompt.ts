...
export const EXEC_DESCRIPTION = `Run raw JavaScript to compose tools; source only, not JSON or markdown fences
No direct Node/filesystem/network/console; await work before isolate exit
Optional first line: // @exec: {"yield_time_ms": 10000, "max_output_tokens": 1000}
Defaults: 30000 ms yield, 10000 output tokens
Use text(value) for final output; notify(value) emits immediately; yield_control() yields
