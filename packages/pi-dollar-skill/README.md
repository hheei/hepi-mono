...
Autocomplete is TUI-only; input expansion also applies to interactive and RPC/print input. Configure enablement and suggestion count in `/ext-settings`; values persist in `${PI_CODING_AGENT_DIR:-~/.pi}/settings.json`.
