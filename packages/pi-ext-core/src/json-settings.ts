...
import type { SettingsState, SettingsStorage, SettingValue } from "./settings.js";
...
declare global {
  var __genericJsonSettingsWriteQueues: Map<string, Promise<void>> | undefined;
}

function settingsWriteQueues(): Map<string, Promise<void>> {
  globalThis.__genericJsonSettingsWriteQueues ??= new Map();
  return globalThis.__genericJsonSettingsWriteQueues;
}
