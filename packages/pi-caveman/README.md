...
Caveman response style for Pi. Provides `/caveman` mode controls, natural-language activation, persistent branch state, configurable main/subagent defaults, and prompt injection for Pi subagents.
