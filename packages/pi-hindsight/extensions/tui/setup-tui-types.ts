...
/** Hub footer: status/setup/emergency first; agent tools own day-to-day advanced edits. */
export const HUB_ACTION_HELP =
	" g guided · m mode · x next-opt-out · f flush · o doctor · n init · d deployment · i import · t templates · q close ";
