...
Pi Hindsight is a Pi-first Hindsight integration. This page is the local workspace support contract.

## Supported runtime matrix

| Component                   | 1.0 support policy                                                                                                                                                                   | Source of truth                                                      |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| Bun                         | `>=1.3.0`                                                                                                                                                                            | HEPI 根目录 `package.json#engines.bun`                               |
| Pi runtime packages         | `>=0.83.0`                                                                                                                                                                           | `package.json#peerDependencies`                                     |
| TypeBox                     | `1.3.7`，由 HEPI 根工作区提供                                                                                                                                                        | HEPI 根目录 `package.json#devDependencies`                           |
...
These surfaces are part of the Pi surface, but the exact fields and behavior can depend on the connected Hindsight server version:
...
Pi Hindsight chooses **stable Pi-first integration** over full upstream global-admin parity.
