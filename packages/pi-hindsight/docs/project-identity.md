...
Older path-bank installs remain readable through legacy `repo:` tags. Use `hindsight_scope_migrate` to preview a dual-tag migration; it never rewrites remote Hindsight documents.
