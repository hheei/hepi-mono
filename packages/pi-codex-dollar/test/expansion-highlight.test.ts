...
assert.equal(expandDollarSkillReferences("Use $librarian.", commands), null);
assert.equal(expandDollarSkillReferences("($librarian )", commands), null);
assert.equal(
	expandDollarSkillReferences("$librarian", commands),
	"/Users/me/.pi/agent/skills/librarian/SKILL.md",
);
assert.equal(
	expandDollarSkillReferences("$librarian ", commands),
	"/Users/me/.pi/agent/skills/librarian/SKILL.md ",
...
assert.equal(
	expandDollarSkillReferences("Use $librarian", commands),
	"Use /Users/me/.pi/agent/skills/librarian/SKILL.md",
);
...
assert.equal(
	highlightDollarSkillReferences("$librarian", commands, {
		fg: (name, text) => `<${name}>${text}</${name}>`,
	}),
	"<codexDollarHighlight>$librarian</codexDollarHighlight>",
);
assert.equal(
