...
export interface BridgeConfig {
	...
	hang_threshold?: number | undefined;
}
...
export interface SubcConfig {
	 ...
	 */
	connection_file?: string | undefined;
}

export interface SemanticConfig {
	backend?: SemanticBackend | undefined;
	model?: string | undefined;
	base_url?: string | undefined;
	api_key_env?: string | undefined;
	timeout_ms?: number | undefined;
	query_timeout_ms?: number | undefined;
...
export interface InspectConfig {
	...
	tier2_idle_minutes?: number | undefined;
	categories?: Record<string, boolean> | undefined;
	tier2_soft_deadline_ms?: number | undefined;
	max_drill_down_items?: number | undefined;
	duplicates?:
		| {
				expected_mirrors?: [string, string][] | undefined;
		  }
		| undefined;
}
...
export interface LspConfig {
	servers?: Record<string, Omit<LspServerConfig, "id">> | undefined;
	disabled?: string[] | undefined;
	python?: "pyright" | "ty" | "auto" | undefined;
	/** Restore legacy inline LSP waits on edit/write unless the tool call overrides diagnostics. */
	diagnostics_on_edit?: boolean | undefined;
...
export interface ExperimentalConfig {
	bash?:
		| {
				...
				long_running_reminder_enabled?: boolean | undefined;
				long_running_reminder_interval_ms?: number | undefined;
		  }
		| undefined;
	lsp_ty?: boolean | undefined;
}
...
export interface BashConfig {
	 ...
	 */
	foreground_wait_window_ms?: number | undefined;
}
...
export interface AftConfig {
	...
	enabled?: boolean | undefined;
	format_on_edit?: boolean | undefined;
	/** Maximum formatter subprocess wallclock seconds. Bounded 1..=600. Default 10. */
	formatter_timeout_secs?: number | undefined;
	validate_on_edit?: "syntax" | "full" | undefined;
	formatter?: Record<string, Formatter> | undefined;
	checker?: Record<string, Checker> | undefined;
	/** Configure-time missing-tool warning delivery. Default: toast. */
	configure_warnings_delivery?: ConfigureWarningsDelivery | undefined;
	tool_surface?: ToolSurface | undefined;
	disabled_tools?: string[] | undefined;
	restrict_to_project_root?: boolean | undefined;
	search_index?: boolean | undefined;
	semantic_search?: boolean | undefined;
	callgraph_store?: boolean | undefined;
	 ...
	 */
	bash?: boolean | BashConfig | undefined;
	experimental?: ExperimentalConfig | undefined;
	lsp?: LspConfig | undefined;
	url_fetch_allow_private?: boolean | undefined;
...
function setPath(root: Record<string, unknown>, path: readonly string[], value: unknown): void {
	...
	const key = path.at(-1);
	if (key === undefined) throw new Error("Cannot set an empty config path");
	parent[key] = value;
}
