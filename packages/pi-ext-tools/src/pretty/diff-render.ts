...
const FG_DEL = FG_RED;
const FG_STRIPE = "\x1b[38;2;40;40;40m";
...
type DiffTheme = Partial<FgTheme>;

function themeFg(theme: DiffTheme, key: ThemeColor, fallback: string): string {
	try {
...
export function resolveDiffColors(theme?: DiffTheme): DiffColors {
	...
	return {
		...
		...(typeof theme.fg === "function" ? { theme: theme as FgTheme } : {}),
		bgAdd: BG_ADD_FAINT,
		bgDel: BG_DEL_FAINT,
		bgAddHighlight: BG_ADD_STRONG,
		bgDelHighlight: BG_DEL_STRONG,
