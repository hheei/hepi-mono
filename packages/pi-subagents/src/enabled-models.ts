 ...
 * `pi-subagents` settings (see `src/settings.ts:loadSettings`). If
 * the project file has `enabledModels` set, it wholly replaces global's
 ...
 * (and matches Pi's own settings precedence).
