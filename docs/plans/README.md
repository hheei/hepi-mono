...
For current behavior, use source code, tests, package READMEs, [Pi Basics development](../development/pi-basics.md), [DESIGN.md](../../DESIGN.md), and the `pi-development` skill's `references/DESIGN.md`.
