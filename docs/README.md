...
[`plans/`](plans/README.md) contains completed or historical design and implementation plans. They preserve decisions and context, but they do not define current behavior. Use source code, tests, package README files, and `DESIGN.md` as the current specification.
...
3. `DESIGN.md` for current TUI design rules.
