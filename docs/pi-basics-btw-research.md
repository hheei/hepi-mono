...
本次只研究四个公开仓库的 BTW 实现，没有复制代码到 `packages/pi-basics`。四个仓库已以浅克隆放在 `references/`，下面的 commit 是本次研究所依据的 revision。

| Repository | Local reference | Revision | BTW implementation |
| --- | --- | --- | --- |
| [dbachelder/pi-btw](https://github.com/dbachelder/pi-btw) | `references/dbachelder-pi-btw` | `4f858102706910ee9d520a9666832f3103631b61` | `extensions/btw.ts` |
| [narumiruna/pi-extensions](https://github.com/narumiruna/pi-extensions) | `references/narumiruna-pi-extensions` | `c5dc930cd85a6f661c3fd530fa62e44109c86070` | `extensions/pi-btw/src/` |
| [juicesharp/rpiv-mono](https://github.com/juicesharp/rpiv-mono) | `references/juicesharp-rpiv-mono` | `700c2d370353ca145d2658c61df1eee6297e8d80` | `packages/rpiv-btw/` |
| [Firstp1ck/npm-packages](https://github.com/Firstp1ck/npm-packages) | `references/Firstp1ck-npm-packages` | `7ff59ae4baa303ccbb66212355ecc335bee3a4c1` | `pi-extension-btw/` |
...
The repository already contains `docs/rpiv-btw-design.md`, a prior design summary. It is useful background, but this document is the comparison against all four implementations.
...
This recommendation is based on migration risk and alignment with current `pi-basics`, not on feature count. The next implementation step should be a small `btw` module registered from `packages/pi-basics/src/index.ts`, with behavior tests before visual polish.
